...
const GlassBlob = ({ color, top, left, size, delay = 0 }: { color: string; top: string; left: string; size: string; delay?: number }) => (
  <motion.div
    ...
    style={{
      ...
      background: color, filter: 'blur(100px)', opacity: 0.1,
...
function TrustCard({ children, index, delay = 0, direction = 'up' }: { children: React.ReactNode; index?: number; delay?: number; direction?: 'left' | 'right' | 'up' }) {
  ...
  return (
    <motion.div
      ...
      style={{
        background: BRAND.white, backdropFilter: 'blur(40px)', borderRadius: 32,
        padding: '48px 40px', border: `1px solid ${BRAND.primary}08`,
        boxShadow: '0 20px 50px rgba(0,0,0,0.03)', position: 'relative', overflow: 'hidden',
      }}
    ...
    <MainLayout background={BRAND.white}>
      <style>{`
        ...
        .dark-section {
          ...
          overflow: hidden;
          margin-bottom: 60px;
          box-shadow: 0 80px 150px rgba(50,45,41,0.25);
        }
        ...
        @media (max-width: 1024px) {
          ...
          .dark-section { padding: 48px 48px; }
        ...
        @media (max-width: 768px) {
          ...
          .stats-row { gap: 24px; margin-top: 36px; }
          ...
          .founder-stats { gap: 32px; margin-top: 40px; }
          ...
          .star-doodle { display: none; }

          .about-page-inner { padding: 0 20px; }
        }

        @media (max-width: 480px) {
          .hero-title { font-size: ${F_SIZE.xl}; }
          .trust-card-inner { padding: 32px 24px !important; }
        }
      `}</style>
      ...
      <div className="hero-gradient" style={{ position: 'relative', zIndex: 1, paddingTop: 120, paddingBottom: 40, overflow: 'hidden', marginTop: 0 }}>
        ...
        <div className="about-page-inner" style={{ maxWidth: 1280, margin: '0 auto', padding: '0 40px' }}>
          ...
          <section className="hero-section">
            ...
            >
              ...
              <p style={{ fontFamily: FONTS.main, fontSize: F_SIZE.md, color: BRAND.secondary, marginTop: 32, lineHeight: 1.7, fontWeight: 500, maxWidth: 540, opacity: 0.9 }}>
              ...
              <div className="stats-row">
                {[
                  ...
                  <motion.div key={i} initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.5 + i * 0.1 }}>
                    <div style={{ fontFamily: FONTS.main, fontSize: F_SIZE.xl, fontWeight: 900, color: BRAND.primary, lineHeight: 1 }}>{stat.val}</div>
            ...
            >
              <div style={{ borderRadius: 48, overflow: 'hidden', boxShadow: `0 60px 120px rgba(114,56,61,0.15)`, border: `8px solid ${BRAND.white}`, position: 'relative' }}>
                <Image src="/images/lab_hero.png" alt="Pharmaceutical Laboratory" width={600} height={700} style={{ objectFit: 'cover', width: '100%', height: 'auto' }} priority />
              ...
              <motion.div
                ...
                style={{ background: BRAND.white, padding: '24px', borderRadius: 24, boxShadow: '0 30px 60px rgba(0,0,0,0.08)', display: 'inline-flex', alignItems: 'center', gap: 16, zIndex: 10, border: `1px solid ${BRAND.primary}10` }}
              >
          ...
          <div style={{ textAlign: 'center', marginBottom: 40 }}>
            ...
            <h2 style={{ fontFamily: FONTS.main, fontSize: 'clamp(1.8rem, 4vw, 2.8rem)', fontWeight: 900, color: BRAND.primaryDark, marginBottom: 12, letterSpacing: '-0.03em' }}>The Trust Layer</h2>
          ...
          <div className="trust-grid">
            <TrustCard index={0} direction="left">
              <div className="trust-card-inner" style={{ padding: 0 }}>
          ...
          <div className="dark-section">
            ...
            <div className="dark-section-grid" style={{ position: 'relative', zIndex: 1 }}>
              <motion.div
              ...
              >
                ...
                <h2 style={{ fontFamily: FONTS.main, fontSize: 'clamp(2rem, 5vw, 4rem)', fontWeight: 900, marginBottom: 32, letterSpacing: '-0.03em', lineHeight: 1 }}>
                  Built by <span style={{ opacity: 0.5 }}>Science.</span>
                </h2>
                <p style={{ fontFamily: FONTS.main, fontSize: F_SIZE.md, lineHeight: 1.8, color: 'rgba(255,255,255,0.8)', fontWeight: 400, maxWidth: 500 }}>
                ...
                <div className="founder-stats">
                  <div>
                    <div style={{ fontFamily: FONTS.main, fontSize: F_SIZE.xl, fontWeight: 900, color: BRAND.tertiary }}>12<span style={{ fontSize: F_SIZE.lg, opacity: 0.5 }}>+</span></div>
                    <div style={{ fontFamily: FONTS.main, fontSize: 11, fontWeight: 800, textTransform: 'uppercase', color: 'rgba(255,255,255,0.4)', letterSpacing: '0.2em', marginTop: 4 }}>Specialists</div>
                  </div>
                  <div style={{ width: 1, height: 60, background: 'rgba(255,255,255,0.1)' }} />
                  <div>
                    <div style={{ fontFamily: FONTS.main, fontSize: F_SIZE.xl, fontWeight: 900, color: BRAND.tertiary }}>240<span style={{ fontSize: F_SIZE.lg, opacity: 0.5 }}>+</span></div>
                    <div style={{ fontFamily: FONTS.main, fontSize: 11, fontWeight: 800, textTransform: 'uppercase', color: 'rgba(255,255,255,0.4)', letterSpacing: '0.2em', marginTop: 4 }}>Formulations</div>
                  </div>
                </div>
              </motion.div>
              ...
              >
                <div style={{ position: 'relative', width: 280, height: 280, margin: '0 auto 40px' }}>
                  ...
                  <div style={{ width: '100%', height: '100%', borderRadius: '50%', background: BRAND.white, border: '12px solid rgba(255,255,255,0.1)', display: 'flex', alignItems: 'center', justifyContent: 'center', boxShadow: '0 40px 100px rgba(0,0,0,0.3)', position: 'relative', overflow: 'hidden' }}>
                ...
                <h3 style={{ fontFamily: FONTS.main, fontSize: 'clamp(1.4rem, 3vw, 2.2rem)', fontWeight: 900, margin: 0, letterSpacing: '-0.02em', color: BRAND.white }}>Dr. S Seenivasan</h3>
                ...
                <div style={{ marginTop: 24, padding: '20px', background: 'rgba(255,255,255,0.05)', borderRadius: 24, border: '1px solid rgba(255,255,255,0.1)', maxWidth: 400, margin: '24px auto 0' }}>
                  <p style={{ fontFamily: FONTS.accent, fontSize: F_SIZE.lg, color: BRAND.white, margin: 0, opacity: 0.9, fontStyle: 'italic' }}>&quot;Standardizing nutrition for every biological potential.&quot; ✨</p>
                </div>
              </motion.div>
            </div>
          </div>
          ...
          <div style={{ textAlign: 'center', paddingTop: 40, paddingBottom: 40, position: 'relative' }}>
            ...
            >
              <h2 style={{ fontFamily: FONTS.main, fontSize: 'clamp(1.8rem, 4vw, 3rem)', fontWeight: 900, color: BRAND.primary, marginBottom: 16, letterSpacing: '-0.04em' }}>Ready to Standardize?</h2>
              ...
              <motion.button
                ...
                whileTap={{ scale: 0.98 }}
                style={{ padding: '24px 60px', background: BRAND.primary, color: BRAND.white, borderRadius: 100, border: 'none', fontFamily: FONTS.main, fontSize: 13, fontWeight: 900, textTransform: 'uppercase', letterSpacing: '0.3em', cursor: 'pointer', transition: 'all 0.4s', boxShadow: '0 20px 40px rgba(114,56,61,0.15)' }}
              >
