    ...
    <div style={{
      ...
      {!loading && reviews.length === 0 && (
        <div style={{
          ...
          <p style={{ fontSize: '16px', color: '#e5e7eb', margin: '0 0 4px 0' }}>No video reviews found</p>
          <p style={{ fontSize: '14px', color: '#6b7280', margin: 0 }}>Create your first video review by clicking the &quot;Add Video Review&quot; button</p>
        </div>
      )}
