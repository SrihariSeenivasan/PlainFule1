                ...
                <div style={{ maxWidth: 1280, margin: '0 auto', position: 'relative', zIndex: 1 }}>
                    ...
                    <div style={{ textAlign: 'center', marginBottom: 80 }}>
                        ...
                        <motion.h2 {...fadeUp(0.12)} style={{
                            ...
                            fontWeight: 900, letterSpacing: '-0.04em', color: C.ink, marginTop: 24
                        }}>What do we do today?</motion.h2 >
                        <motion.p {...fadeUp(0.24)} style={{
                            fontFamily: "'Montserrat', sans-serif",
                            fontSize: 18, color: C.silver, maxWidth: 640, margin: '24px auto 0', lineHeight: 1.6
                        }}>
                            To fill this gap, most people turn to supplements. But this creates another problem:
                        </motion.p>
                    </div>

                    <div className="main-cards-grid">
                        <motion.div {...fadeUp(0.4)} className="glacier-card main-card-box">
                            <h3 style={{ fontFamily: "'Montserrat', sans-serif", fontSize: 28, fontWeight: 900, color: C.ink }}>The Problem</h3>
                            ...
                            <p style={{ fontFamily: "'Montserrat', sans-serif", fontSize: 15, color: C.silver, lineHeight: 1.8, margin: 0 }}>
                        ...
                        <motion.div {...fadeUp(0.5)} className="glacier-card main-card-box" style={{ background: C.deep, border: 'none' }}>
                            ...
                            <p style={{ fontFamily: "'Montserrat', sans-serif", fontSize: 16, color: 'rgba(255,255,255,0.7)', lineHeight: 1.8, margin: 0 }}>
                                PlainFuel simplifies this entire process. Instead of managing multiple supplements, you take one scoop daily. It can replace your regular protein scoop, while also providing essential vitamins, minerals, fiber, and digestive support. No extra planning. No extra tracking. Just a simple daily habit.
                            </p>
                            <div style={{ marginTop: 'auto', display: 'flex', alignItems: 'center', gap: 12 }}>
                                <div style={{ width: 40, height: 2, background: C.leaf }} />
                                <span style={{ fontFamily: "'Caveat', cursive", fontSize: 24, color: C.leaf, fontWeight: 700 }}>One Scoop Daily.</span>
                            </div>
                        </motion.div>
                    </div>
