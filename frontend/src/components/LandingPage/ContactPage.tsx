    ...
    <div style={{ minHeight: '100vh', paddingTop: 96, paddingBottom: 48, background: BRAND.white }}>
      ...
      <div style={{ maxWidth: 1280, margin: '0 auto', padding: '0 24px', display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(460px, 1fr))', gap: 64, alignItems: 'center' }}>
        ...
        >
          ...
          <h1 style={{ fontSize: 'clamp(2.5rem, 6vw, 4.5rem)', lineHeight: 0.95, fontWeight: 900, fontFamily: FONTS.main, color: BRAND.primary, marginBottom: 32, letterSpacing: '-0.04em', margin: 0 }}>
            How can we <br />
            <span style={{ color: BRAND.primaryDark }}>optimize</span> your <br />
            experience?
          </h1>

          <p style={{ fontFamily: FONTS.main, fontSize: F_SIZE.md, fontWeight: 800, color: BRAND.secondary, maxWidth: 480, marginBottom: 48, lineHeight: 1.7, marginTop: 24 }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 32 }}>
            <div style={{ display: 'flex', gap: 24, alignItems: 'flex-start' }}>
              ...
              <div>
                <h4 style={{ fontFamily: FONTS.main, fontWeight: 800, color: BRAND.secondary, textTransform: 'uppercase', letterSpacing: '0.15em', fontSize: F_SIZE.md, marginBottom: 6, opacity: 0.7 }}>Support Email</h4>
            ...
            <div style={{ display: 'flex', gap: 24, alignItems: 'flex-start' }}>
              ...
              <div>
                <h4 style={{ fontFamily: FONTS.main, fontWeight: 800, color: BRAND.secondary, textTransform: 'uppercase', letterSpacing: '0.15em', fontSize: F_SIZE.md, marginBottom: 6, opacity: 0.7 }}>Direct Line</h4>
            ...
            <div style={{ display: 'flex', gap: 24, alignItems: 'flex-start' }}>
              ...
              <div>
                <h4 style={{ fontFamily: FONTS.main, fontWeight: 800, color: BRAND.secondary, textTransform: 'uppercase', letterSpacing: '0.15em', fontSize: F_SIZE.md, marginBottom: 6, opacity: 0.7 }}>Corporate HQ</h4>
        ...
        >
          <div style={{ background: 'rgba(255,255,255,0.6)', backdropFilter: 'blur(32px)', borderRadius: 48, border: `1px solid ${BRAND.tertiary}40`, boxShadow: `0 40px 80px rgba(50,45,41,0.08)`, padding: '48px 56px' }}>
