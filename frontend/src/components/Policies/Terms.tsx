      ...
      >
        ...
        <motion.div className="bg-white rounded-2xl shadow-lg p-8 md:p-12 space-y-8">
          ...
          <motion.section variants={itemVariants} className="space-y-4">
            <h2 style={{ fontSize: F_SIZE.lg, fontFamily: "'Montserrat', sans-serif", color: '#0a3d1f' }} className="font-bold flex items-center gap-3">
              <span style={{ fontSize: F_SIZE.sm }} className="w-8 h-8 bg-[#16a34a] text-white rounded-xl shadow-sm flex items-center justify-center font-bold">1</span>
              Acceptance of Terms
            </h2>
            <p style={{ fontSize: F_SIZE.md }} className="text-gray-700 leading-relaxed font-medium">
          ...
          <motion.section variants={itemVariants} className="space-y-4">
            <h2 style={{ fontSize: F_SIZE.lg, fontFamily: "'Montserrat', sans-serif", color: '#0a3d1f' }} className="font-bold flex items-center gap-3">
              <span style={{ fontSize: F_SIZE.sm, fontFamily: "'Montserrat', sans-serif" }} className="w-8 h-8 bg-[#16a34a] text-white rounded-xl shadow-sm flex items-center justify-center font-bold">2</span>
              Use License
            </h2>
            <p style={{ fontSize: F_SIZE.md }} className="text-gray-700 leading-relaxed font-medium">
          ...
          <motion.section variants={itemVariants} className="space-y-4">
            <h2 style={{ fontSize: F_SIZE.lg, fontFamily: "'Montserrat', sans-serif", color: '#0a3d1f' }} className="font-bold flex items-center gap-3">
              <span style={{ fontSize: F_SIZE.sm, fontFamily: "'Montserrat', sans-serif" }} className="w-8 h-8 bg-[#16a34a] text-white rounded-xl shadow-sm flex items-center justify-center font-bold">3</span>
              User Accounts
            </h2>
            <p style={{ fontSize: F_SIZE.md }} className="text-gray-700 leading-relaxed font-medium">
            ...
            <p style={{ fontSize: F_SIZE.md, fontFamily: "'Montserrat', sans-serif", color: '#14532d' }} className="leading-relaxed mt-4 font-medium opacity-80">
          ...
          <motion.section variants={itemVariants} className="space-y-4">
            ...
            <p style={{ fontSize: F_SIZE.md, fontFamily: "'Montserrat', sans-serif", color: '#14532d' }} className="leading-relaxed mt-4 font-medium opacity-80 text-gray-700">
          ...
          <motion.section variants={itemVariants} className="border-t pt-8 space-y-4">
            <h2 style={{ fontSize: F_SIZE.lg, fontFamily: "'Montserrat', sans-serif", color: '#0a3d1f' }} className="font-bold">Questions About Our Terms?</h2>
            ...
            <div className="bg-green-50 p-6 rounded-2xl space-y-3 border border-green-100">
              <p style={{ fontSize: F_SIZE.md, fontFamily: "'Montserrat', sans-serif", color: '#0a3d1f' }} className="font-bold">PlainFuel Legal Team</p>
              <p style={{ fontSize: F_SIZE.md, fontFamily: "'Montserrat', sans-serif", color: '#14532d' }} className="font-medium opacity-80">Email: legal@plainfuel.com</p>
              <p style={{ fontSize: F_SIZE.md, fontFamily: "'Montserrat', sans-serif", color: '#14532d' }} className="font-medium opacity-80">Address: PlainFuel Inc., USA</p>
              <p style={{ fontSize: F_SIZE.md, fontFamily: "'Montserrat', sans-serif", color: '#14532d' }} className="font-medium opacity-80">Phone: 1-800-PLAINFUEL</p>
            </div>
          </motion.section>
        </motion.div>
      </motion.div>
