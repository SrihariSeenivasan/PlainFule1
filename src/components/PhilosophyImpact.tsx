...
export default function PhilosophyImpact() {
    return (
        <section className="bg-[var(--dark-2)] section-pad relative overflow-hidden">
            {/* Large background text */}
            <div className="absolute inset-0 flex items-center justify-center pointer-events-none select-none overflow-hidden">
                <span className="font-playfair text-[25vw] font-black text-[var(--foreground)]/[0.015] leading-none whitespace-nowrap">PURITY</span>
            </div>
            ...
            <div className="max-w-4xl mx-auto px-6 md:px-12 relative z-10 text-center">
                ...
                <motion.h2
                    ...
                    className="font-playfair text-5xl md:text-8xl font-black text-[var(--foreground)] leading-[0.9] tracking-tight mb-10"
                >
                    Clean is{' '}
                    <span className="font-playfair italic text-[var(--foreground)]/20">not enough.</span>
                    <br />
                    <SketchHighlight type="underline" delay={0.8}>Efficiency</SketchHighlight>{' '}
                    <span style={{ background: 'linear-gradient(135deg, #7cb342, #053b05)', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent', backgroundClip: 'text' }}>is.</span>
                </motion.h2>
                ...
                >
                    <p className="text-[var(--foreground)]/70 text-lg font-light leading-relaxed">
                        We don&apos;t build for the trend. We build for the long-term metabolism of the modern individual.
                    </p>
                    <p className="text-[var(--foreground)]/40 text-base leading-relaxed font-light">
