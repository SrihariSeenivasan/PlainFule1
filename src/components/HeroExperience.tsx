...
export default function HeroExperience() {
    return (
        <section className="relative min-h-screen bg-[var(--background)] flex items-center overflow-hidden">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center min-h-[calc(100vh-7rem)]">
                    ...
                    <div>
                        ...
                        <motion.h1
                            ...
                            className="font-playfair text-[4rem] md:text-[5.5rem] lg:text-[6.5rem] font-black leading-[0.88] tracking-tight text-[var(--foreground)] mb-8"
                        >
                            The{' '}
                            <SketchHighlight type="circle" delay={1.2}>
                                <span className="font-playfair italic" style={{ background: 'linear-gradient(135deg, #7cb342, #053b05)', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent', backgroundClip: 'text' }}>
                                    Delta.
                                </span>
                            </SketchHighlight>
                            <br />
                            <span className="text-[var(--foreground)]/20">Complete.</span>
                        </motion.h1>
                        ...
                        <motion.p
                            ...
                            className="text-xl text-[var(--foreground)]/60 font-light leading-relaxed mb-12 max-w-md"
                        >
                        ...
                        >
                            <a href="#buy"
                                className="group inline-flex items-center gap-3 bg-gradient-to-r from-[#053b05] to-[#4a8540] text-white px-8 py-4 rounded-full font-bold text-sm uppercase tracking-[0.1em] shadow-[0_8px_30px_rgba(58,107,53,0.4)] hover:shadow-[0_8px_40px_rgba(122,195,66,0.4)] hover:-translate-y-0.5 transition-all duration-200">
                                Pre-Order Now
                                <ArrowRight className="w-4 h-4 group-hover:translate-x-1 transition-transform" />
                            </a>
                            <a href="#investigation"
                                className="inline-flex items-center gap-2 text-[var(--foreground)]/40 hover:text-[var(--foreground)] text-sm font-semibold tracking-wide transition-colors">
                                See the science
                        ...
                        >
                            {['FSSAI Certified', 'Zero Fillers', '26 Micronutrients', 'Lab Verified'].map((tag, i) => (
                                <div key={i} className="flex items-center gap-2">
                                    ...
                                    <span className="text-[11px] font-bold uppercase tracking-[0.1em] text-[var(--foreground)]/30">{tag}</span>
                                </div>
                            ))}
                        </motion.div>
                    </div>
                    ...
                    >
                        <div className="relative w-[280px] md:w-[360px] lg:w-[420px] aspect-[3/4]">
                            ...
                            >
                                ...
                                <p className="text-[var(--foreground)] text-sm font-bold">4.9/5</p>
                                <p className="text-[var(--foreground)]/40 text-[10px]">Early adopters</p>
                            </motion.div>
                            ...
                            >
                                ...
                                <p className="text-[var(--foreground)] text-2xl font-black">₹599</p>
                                <p className="text-[var(--foreground)]/30 text-xs line-through">₹899</p>
                            </motion.div>
                        </div>
                    </motion.div>
            ...
            {/* Bottom fade */}
            <div className="absolute bottom-0 inset-x-0 h-32 bg-gradient-to-t from-[var(--background)] to-transparent z-10" />
        </section>
    );
}
